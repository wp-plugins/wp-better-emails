...
if ( !class_exists( 'WP_Better_Emails' ) ) {
	...
	class WP_Better_Emails {
		 ...
		 */
		function admin_menu() {
			$this->page = add_options_page(__('Email settings', 'wp-better-emails'), __('Email', 'wp-better-emails'), 'administrator', 'wpbe_options', array(&$this, 'admin_page'));
		...
		function ajax_send_preview( $email ) {
			...
			if( wp_mail( $preview_email, '[' . wp_specialchars_decode(get_option('blogname'), ENT_QUOTES) . '] - ' . __('Email template preview', 'wp-better-emails'), $message) )
				die('<div class="updated"><p>' . __('An email preview has been successfully sent to ' . esc_attr($preview_email), 'wp-better-emails') . '</p></div>');
			else
		...
		function contextual_help($contextual_help, $screen_id, $screen) {
			...
			return '<p>' . __('Some dynamic tags can be included in your email template :', 'wp-better-emails') . '</p>
					<ul>
						<li>' . __('<strong>%content%</strong> : will be replaced by the message content.', 'wp-better-emails') . '<br />
						...
						<li>' . __('<strong>%blog_url%</strong> : will be replaced by your blog URL.', 'wp-better-emails') . '</li>
						<li>' . __('<strong>%home_url%</strong> : will be replaced by your home URL.', 'wp-better-emails') . '</li>
						<li>' . __('<strong>%blog_name%</strong> : will be replaced by your blog name.', 'wp-better-emails') . '</li>
						<li>' . __('<strong>%blog_description%</strong> : will be replaced by your blog description.', 'wp-better-emails') . '</li>
						<li>' . __('<strong>%admin_email%</strong> : will be replaced by admin email.', 'wp-better-emails') . '</li>
						<li>' . __('<strong>%date%</strong> : will be replaced by current date, as formatted in <a href="options-general.php">general options</a>.', 'wp-better-emails') . '</li>
						<li>' . __('<strong>%time%</strong> : will be replaced by current time, as formatted in <a href="options-general.php">general options</a>.', 'wp-better-emails') . '</li>
					</ul>';
		}
